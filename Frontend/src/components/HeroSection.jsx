...
const HeroSection = () => {
  ...
  const { token, showAnimation, setShowAnimation } = useContextAPI();
    ...
    <div className='hero-section'>
      <div className='hero-section-inside'>
        ...
        <div className='welcome-div'>
          <h1 className='hero-section-text'>Open Source, Open Future.</h1>

          <p className='hero-section-sub-text'>
            Join the movement of developers shaping the future with
            Free & Open Source Software — transparent, collaborative,
            and limitless.
          </p>
        </div>
